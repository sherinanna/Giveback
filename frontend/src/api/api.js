...
class GivebackApi {
  ...
  static async request(endpoint, data = {}, method = "get") {
    ...
    const headers = { Authorization: `Bearer ${GivebackApi.token}` };
  ...
  /** Get list of events (filtered by title , zipcode if not undefined) */
  ...
  static async applyToEvent(username, id) {
